			...
			<footer>
				<div style={{ borderTop: "1px solid lightgrey" }}>
					...
					{this.props.viewStore.filterTags.map((tag, i) => (
						<a key={i} style={this.props.viewStore.activeFilterTag === tag ? activeFilterTags : filterTags} onClick={e => this.props.viewStore.updateActiveFilterTag(e.currentTarget.innerHTML)}>{tag}</a>
					))}
				</div>
